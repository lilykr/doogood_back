...
CREATE TABLE IF NOT EXISTS `doogood`.`event` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_event_charity1_idx` (`charity_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `doogood`.`charity_has_category` (
  ...
  INDEX `fk_charity_has_category_category1_idx` (`category_id` ASC) VISIBLE,
  INDEX `fk_charity_has_category_charity_idx` (`charity_id` ASC) VISIBLE,
